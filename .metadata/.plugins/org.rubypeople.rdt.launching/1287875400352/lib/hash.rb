...
Includes:
---------
     Enumerable(all?, any?, as_json, collect, count, cycle, detect,
     drop, drop_while, each_cons, each_slice, each_with_index,
...
Instance methods:
-----------------
     ==, [], []=, bind, clear, deep_symbolize_keys, default, default=,
     default_proc, delete, delete_if, each, each_key, each_pair,
     each_value, empty?, eql?, except, fetch, has_key?, has_value?,
     hash, include?, index, indexes, indices, initialize_copy, inspect,
     invert, key?, keys, length, member?, merge, merge!, pretty_print,
     pretty_print_cycle, rehash, reject, reject!, replace, select,
     shift, size, slice, sort, store, to_a, to_hash, to_http_str, to_s,
     to_yaml, update, value?, values, values_at, yaml_initialize
