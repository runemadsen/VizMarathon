...
class MatchData < Object
  ...
  # ------------------------------------------------------------------------
  #      Returns an array containing match strings for which _block_ gives
  #      +true+. MatchData#select will be removed from Ruby 1.9.
  # 
  #         m = /(.)(.)(\d+)(\d)/.match("THX1138: The Movie")
  ...
  #      mtch.inspect   => str
  # ------------------------------------------------------------------------
  #      Returns a printable version of _mtch_.
  # 
