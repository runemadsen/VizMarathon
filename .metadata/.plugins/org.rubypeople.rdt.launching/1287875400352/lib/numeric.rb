...
Includes:
---------
     Comparable(<, <=, ==, >, >=, between?), Prawn::Measurements(cm2mm,
     cm2pt, dm2mm, dm2pt, ft2in, ft2pt, in2pt, m2mm, m2pt, mm2pt, pt2mm,
     yd2in, yd2pt)


Instance methods:
-----------------
     +@, -@, <=>, abs, angle, arg, blank?, ceil, cm, coerce, conj,
     conjugate, degrees, div, divmod, dm, eql?, fdiv, floor, ft, im,
     imag, image, in, integer?, m, mm, modulo, nonzero?, polar, pt, quo,
     radians, real, remainder, round, singleton_method_added, step,
     to_int, truncate, yd, zero?
