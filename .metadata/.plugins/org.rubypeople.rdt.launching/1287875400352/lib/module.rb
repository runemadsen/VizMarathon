...
Instance methods:
-----------------
     <, <=, <=>, ==, ===, >, >=, abstract_method, alias_method,
     ancestors, append_features, attr, attr_accessor, attr_reader,
     attr_writer, autoload, autoload?, class_eval, class_exec,
     class_variable_defined?, class_variable_get, class_variable_set,
     class_variables, const_defined?, const_get, const_missing,
     const_set, constants, define_method, extend_object, extended,
     freeze, include, include?, included, included_modules,
